...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('template_admin/') ?>assets/css/lib/datatable/dataTables.bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo base_url('template_admin/') ?>assets/scss/style.css">
    <link href="<?php echo base_url('template_admin/') ?>assets/css/lib/vector-map/jqvmap.min.css" rel="stylesheet">
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url('') ?>Admin"><img src="<?php echo base_url('template_admin/') ?>images/logo.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="./"><img src="<?php echo base_url('template_admin/') ?>images/logo2.png" alt="Logo"></a>
            </div>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <a href="<?php echo base_url('Users') ?>"> <i class="menu-icon fa fa-user"></i>Users</a>
            ...
            <div class="header-menu">
                ...
                <div class="col-sm-7">
                  ...
                  <div class="dropdown-menu" aria-labelledby="message">
                    ...
                    <a class="dropdown-item media bg-flat-color-1" href="#">
                        <span class="photo media-left"><img alt="avatar" src="<?php echo base_url('template_admin/') ?>images/avatar/1.jpg"></span>
                    ...
                    <a class="dropdown-item media bg-flat-color-4" href="#">
                        <span class="photo media-left"><img alt="avatar" src="<?php echo base_url('template_admin/') ?>images/avatar/2.jpg"></span>
                        <span class="message media-body">
                    ...
                    <a class="dropdown-item media bg-flat-color-5" href="#">
                        <span class="photo media-left"><img alt="avatar" src="<?php echo base_url('template_admin/') ?>images/avatar/3.jpg"></span>
                        <span class="message media-body">
                    ...
                    <a class="dropdown-item media bg-flat-color-3" href="#">
                        <span class="photo media-left"><img alt="avatar" src="<?php echo base_url('template_admin/') ?>images/avatar/4.jpg"></span>
                        <span class="message media-body">
    ...
    <div class="col-sm-5">
        <div class="user-area dropdown float-right">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="user-avatar rounded-circle" src="<?php echo base_url('template_admin/') ?>images/admin.jpg" alt="User Avatar">
            </a>

            <div class="user-menu dropdown-menu">
                <a class="nav-link" href="#"><i class="fa fa- user"></i><?php echo $this->session->userdata('logged_in')['nama']; ?></a>
